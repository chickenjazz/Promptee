...
- A fully automated prompt optimization pipeline using a fine-tuned Qwen2.5-3B-Instruct.
...
- **Model details**: Qwen2.5-3B-Instruct is the base model. LoRA adapters live in `models/adapters/`.
